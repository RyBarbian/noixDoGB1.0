...
// Global state
//
static const uint256 hashGenesisBlockOfficial("0x000001b22fbe32eae722e9033bee2aad4a55e9a057f402c35ec7491139240aa0");
static const uint256 hashGenesisBlockTestNet ("0x00000769acb99e24415ff5e2c96f42da8894f7dced3777394a0ee564d395379c");
                        ...
                        bool* pfMissingInputs)
{
    ...
    // peercoin: coinstake is also only valid in a block, not as a loose transaction
    if (tx.IsCoinStake())
...
void static InvalidChainFound(CBlockIndex* pindexNew)
{
    ...
    // peercoin: should not enter safe mode for longer invalid chain
}
...
bool CBlock::DisconnectBlock(CTxDB& txdb, CBlockIndex* pindex)
{
    ...
    // peercoin: clean up wallet after disconnecting coinstake
...
bool CBlock::AddToBlockIndex(unsigned int nFile, unsigned int nBlockPos)
{
    ...
    // peercoin: compute chain trust score
...
bool CBlock::CheckBlock() const
{
    ...
    // peercoin: coinbase output should be empty if proof-of-stake block
...
bool ProcessBlock(CNode* pfrom, CBlock* pblock)
{
    ...
    if (!mapBlockIndex.count(pblock->hashPrevBlock))
    {
        ...
        if (pfrom)
        {
            ...
            // peercoin: getblocks may not obtain the ancestor block rejected
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Watch out for the the mind-worms";
        unsigned int nTimeGenesis=1518292632;
        unsigned int nNonceGenesis=2284901;

        if (fTestNet)
        {
            pszTimestamp="They disguise themselves as tendrils.";
        ...
        printf("%s\n", block.hashMerkleRoot.ToString().c_str());
        if (!fTestNet)
            assert(block.hashMerkleRoot == uint256("0x653e0b489dd0a62ee29180655616a7aa7049e9b22bc0b4522496113ff51075bc"));
        else
            assert(block.hashMerkleRoot == uint256("0xafaf4bf8d999fe489807f335df362bef9487049007d9f3b5cb3a19dd0259a698"));
...
string GetWarnings(string strFor)
{
    ...
    // peercoin: should not enter safe mode for longer invalid chain
    // peercoin: if sync-checkpoint is too old do not enter safe mode
    ...
    // Alerts
    {
        ...
        BOOST_FOREACH(PAIRTYPE(const uint256, CAlert)& item, mapAlerts)
        {
            ...
            if (alert.AppliesToMe() && alert.nPriority > nPriority)
            {
                ...
                if (nPriority > 1000)
                    strRPC = strStatusBar;  // peercoin: safe mode for high alert
            }
        }
    }
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "version")
    {
        ...
        // peercoin: record my external IP reported by peer
...
CBlock* CreateNewBlock(CReserveKey& reservekey, CWallet* pwallet, bool fProofOfStake)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // peercoin: simplify transaction fee - allow free = false
