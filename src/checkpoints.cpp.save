...
namespace Checkpoints
{
    ...
    // GoDXoin: synchronized checkpoint (centrally broadcasted)
    ...
    // GoDXoin: get last synchronized checkpoint
    ...
    // GoDXoin: only descendant of current sync-checkpoint is allowed
    ...
    // GoDXoin: reset synchronized checkpoint to last hardened checkpoint
...
// GoDXoin: sync-checkpoint master key
...
// GoDXoin: verify signature of sync-checkpoint message
...
// GoDXoin: process synchronized checkpoint
