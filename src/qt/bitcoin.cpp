...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occured. GoDXoin can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
// TODO: implement qtipcserver.cpp for Mac and Windows
    ...
    {
        if (strlen(argv[i]) >= 7 && strncasecmp(argv[i], "godxoin:", 11) == 0)
        {
    ...
    app.setOrganizationName("GoDXoin");
    app.setOrganizationDomain("godxoin.net");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("GoDXoin-Qt-testnet");
    else
        app.setApplicationName("GoDXoin-Qt");
