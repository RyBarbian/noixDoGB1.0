...
When a developer works on a phase, he pushes his changes to a new branch on his own fork of Smiles (he's free to choose the name of the branch, but using the phase branch name makes it easier). He then makes a pull request from his branch to the current phase branch on Smiles' repository.
...
We never force a push on Smiles' repository.
